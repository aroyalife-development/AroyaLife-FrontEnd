						...
						<Col md="6" lg="4" className="bg-white">
							<div className="p-4">
								...
								<Form className="mt-3" id="loginform" action="/dashbaord">
									...
									<Row className="mb-3">
										<Col xs="12">
											<Button color="success" onClick={this.doLogin} className={`${this.validForm() ? '' : 'disabled'}`} size="lg" type="submit" block>Log In</Button>
									...
									<div className="text-center">
										Don&apos;t have an account? <a href="/authentication/subscription" className="text-info ml-1"><b>Sign Up</b></a>
									</div>
								</Form>
							</div>
